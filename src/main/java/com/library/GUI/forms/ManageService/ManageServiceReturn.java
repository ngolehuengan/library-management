...
public class ManageServiceReturn {
    ...
    static void init(javax.swing.JComponent pnlCards) {
        ...
        details.setBorder(
                new javax.swing.border.TitledBorder(null, "Thông Tin Chi Tiết",
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "STT", "NGÀY MƯỢN", "NGÀY HẸN TRẢ", "NGƯỜI MƯỢN", "MÃ TÀI LIỆU", "NHAN ĐỀ", "ĐÃ GIA HẠN"
                }) {
            @Override
        ...
        subTable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "STT", "MÃ TÀI LIỆU", "NHAN ĐỀ", "SỐ NGÀY QUÁ HẠN", "TIỀN PHẠT"
                }) {
            @Override
            public boolean isCellEditable(int rowIndex, int columnIndex) {
                return false;
