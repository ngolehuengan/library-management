...
public class ManageInventoryImport {
    ...
    private static void removeRecord() {
        if (Handle.confirm()) {
            if (new ImportRecordBUS().delete(vtDTO.get(table.getSelectedRow()))) {
                javax.swing.JOptionPane.showMessageDialog(null, "Đã xoá!");
                resetPage();
            } else {
                javax.swing.JOptionPane.showMessageDialog(null, "Không thể xoá!");
