...
public class ManageInventoryImport {
	...
	static void init(javax.swing.JComponent pnlCards) {
		...
		table.setModel(new javax.swing.table.DefaultTableModel(new ImportRecordBUS().getTable(), TableHeader.importRecord()) {
			@Override
		...
		subTable.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
                subTable.setModel(new javax.swing.table.DefaultTableModel(new Vector(), TableHeader.importDetail() ) {
			@Override
			public boolean isCellEditable(int rowIndex, int columnIndex) {
				return false;
			}
