<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <head>
            ...
            <link rel="shortcut icon" href="${contextPath}/resources/images/sgu-logo.ico" type="image/x-icon" />
        ...
        <body>
            <header id="header" class="sticky-top">
                <nav class="navbar" aria-label="#">
                    <div class="container">
                        <a href="${pageContext.request.contextPath}" class="col-ms-7 navbar-brand"><img
                                src="${contextPath}/resources/images/header-logo.png" alt="SGU Library"></a>
                        <div class="col-ms-5">
                            <div class="link-header">
                                <ul class="contact-menu">
                                    <li><a href="https://sgu.edu.vn/" target="_blank">Website SGU</a></li>
                                    <li><a href="http://thongtindaotao.sgu.edu.vn/" target="_blank">Thông tin đào
                                            tạo</a></li>
                                    <li><a href="http://mail.lib.sgu.edu.vn:3000/" target="_blank">Web-mail</a></li>
                                </ul>
                            </div>
                            <div class="link-header">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                                href="${pageContext.request.contextPath}/views/content/intro.jsp">GIỚI
                                                THIỆU CHUNG</a></li>
                                        <li><a class="dropdown-item"
                                                href="${pageContext.request.contextPath}/views/content/rule.jsp">NỘI
                                                QUY</a></li>
